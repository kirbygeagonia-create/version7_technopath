...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        training_examples = [
            ...
            {"query_text": "Who is the president?", "intent_label": "founders"},
            {"query_text": "Who is the president of SEAIT?", "intent_label": "founders"},
            {"query_text": "SEAIT president", "intent_label": "founders"},
            {"query_text": "School president", "intent_label": "founders"},
            {"query_text": "President of the school", "intent_label": "founders"},
            {"query_text": "Who leads SEAIT?", "intent_label": "founders"},
            {"query_text": "School administrator", "intent_label": "founders"},
            {"query_text": "Who is the chairman?", "intent_label": "founders"},
            {"query_text": "Who is the director?", "intent_label": "founders"},
            ...
            {"query_text": "How many courses that school offered?", "intent_label": "courses"},
            {"query_text": "What courses are available?", "intent_label": "courses"},
            {"query_text": "Total courses", "intent_label": "courses"},
            {"query_text": "Course count", "intent_label": "courses"},
            {"query_text": "How many programs?", "intent_label": "courses"},
            {"query_text": "List all courses", "intent_label": "courses"},
            {"query_text": "What degrees are offered?", "intent_label": "courses"},
            {"query_text": "Available degrees", "intent_label": "courses"},
